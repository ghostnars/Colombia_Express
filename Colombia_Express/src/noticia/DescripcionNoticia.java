...
public class DescripcionNoticia extends Metodos implements FieldChangeListener {
	...
	public DescripcionNoticia(String idOferta, String imagen,String descripcion, String oferta, String regular) {
		Imagen = imagen;
		...
		getMainManager().setBackground(
				BackgroundFactory.createBitmapBackground(bitmapImg));
		// Barra Titulo
		...
		HorizontalFieldManager fmTitulo = new HorizontalFieldManager(
				Field.FIELD_VCENTER);
		fmTitulo.setMargin(0, 200, 0, 0);
		HorizontalFieldManager fmActualizar = new HorizontalFieldManager();

		btnHome = new BitmapButtonField(Bitmap.getBitmapResource("home1.png"),
				Bitmap.getBitmapResource("home1.png"));
		btnHome.setChangeListener(this);

		btnUpdate = new BitmapButtonField(Bitmap.getBitmapResource("sync.png"),
				Bitmap.getBitmapResource("sync.png"));
		...
		HorizontalFieldManager content = new HorizontalFieldManager(
				Field.USE_ALL_WIDTH | HorizontalFieldManager.NO_VERTICAL_SCROLL);
	...
	public void fieldChanged(Field field, int context) {
		...
		if (btnHome == field) {
			...
			engine.setTransition(this, null, UiEngineInstance.TRIGGER_PUSH,
					transition);
			openScreen(new Menu());
		}
	}
